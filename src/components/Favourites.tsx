...
const Favourites = ({ fav }: { fav: String | null }) => {
  ...
  return (
    <div className=" m-4 ml-10 mb-1 rounded-md hover:scale-105 transition-transform">
      <Card
        sx={{
          height: 150,
          width: 200,
      ...
      >
        ...
        <CardContent>
          <div className="text-center bg-opacity-80  ">
            {fav || "Tap to add this location to favourites"}
          </div>
