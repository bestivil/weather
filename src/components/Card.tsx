          ...
          <div className="flex justify-around">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 relative">
                <span className="font-bold text-sm z-10">{feelsLike}</span>
            ...
            <div className="flex flex-col items-center ml-2">
              ...
              <svg className=" w-16 h-16 wr-wind-speed__icon__svg mt-5">
                <defs>
                  <symbol id="a" viewBox="0 0 32 32">
                    ...
                    >
                      {windDir}
                      {/* TODO: fit text inrotate svg based on result */}
                    </text>
                  </symbol>
                </defs>
              ...
              <p className="font-bold text-sm z-10">{wind}mph</p>
            </div>
			...
			C512,215.438,477.43,175.558,431.978,167.288z"
              ...
              <p className="font-bold text-sm z-10 mt-2">{precipMM} mm</p>
            </div>
            <div className="flex flex-col items-center">
              ...
              <p className="font-bold text-sm z-10 mt-1">{vis_km}km</p>
            </div>
          </div>
        </CardContent>
        <CardActions></CardActions>
